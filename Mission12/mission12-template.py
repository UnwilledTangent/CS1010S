...
def install_complex_package():
    ...
    def negate_com(x):                                          # Input: Generic-Com, Output: Generic-Com
        return make_com(negate(real(x)), negate(imag(x)))
    
    def is_zero_com(x):                                         # Input: Generic-Com, Output: Boolean
        return (is_zero(real(x)) and is_zero(imag(x))) # only returns True if both are True
    
    def is_eq_com(x,y):                                         # Input: Generic-Com, Output: Boolean
        real_equal = is_equal(real(x),real(y))
        imag_equal = is_equal(imag(x),imag(y))
    ...
    put("add", ("ordinary", "complex"), CCmethod_to_COmethod(add_com))
    put("add", ("complex", "ordinary"), CCmethod_to_OCmethod(add_com))
    put("sub", ("ordinary", "complex"), CCmethod_to_COmethod(sub_com))
    put("sub", ("complex", "ordinary"), CCmethod_to_OCmethod(sub_com))
    put("mul", ("ordinary", "complex"), CCmethod_to_COmethod(mul_com))
    put("mul", ("complex", "ordinary"), CCmethod_to_OCmethod(mul_com))
    put("div", ("ordinary", "complex"), CCmethod_to_COmethod(div_com))
    put("div", ("complex", "ordinary"), CCmethod_to_OCmethod(div_com))
    put("is_equal", ("ordinary", "complex"), CCmethod_to_COmethod(is_eq_com))
    put("is_equal", ("complex", "ordinary"), CCmethod_to_OCmethod(is_eq_com))
